...
public class ObjectMoving : MonoBehaviour {
	...
	public bool IF_PENDING{get{return moveState == MOVESTATE.PENDING;}}
	private Vector3 Nextpos;
	private Vector3 originPos;
	private MoveToTask moveToTask;
	private Task_Manager taskManager = new Task_Manager();
	private FSM<ObjectMoving> _fsm;

	void Start() {
		_fsm = new FSM<ObjectMoving>(this);
	...
	public class ObjectState: FSM<ObjectMoving>.State {
